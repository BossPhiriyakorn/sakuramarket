...
import { getVerificationDocumentsList } from "@/lib/api/dbStore";
...
export async function GET() {
  ...
  try {
    const verificationDocuments = await getVerificationDocumentsList();
    return NextResponse.json(verificationDocuments);
  } catch (e) {
